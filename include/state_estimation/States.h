...
enum FlightState : uint8_t {
    STATE_UNARMED           = 0, // 0x00
    STATE_ARMED             = 1, // 0x01
    STATE_SOFT_ASCENT       = 2, // 0x02
    STATE_ASCENT            = 3, // 0x03 Don't use the ascent state if you are already using powered ascent and coast ascent
    STATE_POWERED_ASCENT    = 4, // 0x04
    STATE_COAST_ASCENT      = 5, // 0x05
    STATE_DESCENT           = 6, // 0x06
    STATE_DROGUE_DEPLOYED   = 7, // 0x07
    STATE_MAIN_DEPLOYED     = 8, // 0x08
    STATE_LANDED            = 9, // 0x09
};
